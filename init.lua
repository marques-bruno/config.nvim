...
vim.keymap.set('n', '<C-h>', '<cmd>bp<cr>', { desc = 'Move focus to the left window' })
vim.keymap.set('n', '<C-l>', '<cmd>bn<cr>', { desc = 'Move focus to the right window' })
vim.keymap.set('n', '<C-j>', '<cmd>tabp<cr>', { desc = 'Move focus to the lower window' })
vim.keymap.set('n', '<C-k>', '<cmd>tabn<cr>', { desc = 'Move focus to the upper window' })
